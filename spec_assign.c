...
void assign_objects(void)
{
  ...
  ASSIGNOBJ(1218, gen_board);   /* Immortal Archive1 */
  ASSIGNOBJ(1217, gen_board);   /* nexus board */
  ASSIGNOBJ(1215, gen_board);   /* immortal social board */
  ASSIGNOBJ(1214, gen_board);   /* Todo Board */
  ASSIGNOBJ(1213, gen_board);   /* builders board */
  ASSIGNOBJ(1212, gen_board);   /* coders board */
  ASSIGNOBJ(1211, gen_board);   /* scripters board */
  ASSIGNOBJ(1618, gen_board);   /* knight board */
  ASSIGNOBJ(1654, gen_board);   /* cavalier board */
