...
/* minimum level a player must be to shout/holler/role/auction */
...
/* "okay" etc. */
const char *OK = "It has been done.\r\n";
...
" |-|    _/############//      ((v|v))      ))#############_  |-|\r\n"
" | |---/-------------((-|-voV--)~|~/--Vov-|-))-------------)-| |\r\n"
" |-| -`B M U D G I K  I I`n - '^`  (. .)  ' -   `B M E N U`n    -    |-|\r\n"
" | |      ~~~~~~~~~~~           (Y)       ~~~~~~~~~~~~~      | |\r\n"
" |-|`y 0`n) Save and exit game.       `y 3`n) Read Background Story. |-|\r\n"
" |-|`y 1`n) Return to Game.           `y 4`n) Change Password.       |-|\r\n"
" |-|`y 2`n) Enter your description    `y 5`n) Delete Character.      |-|\r\n"
...
"\r\n"
"Welcome to the land of Mudgik II!  Please do not feed the Immortals!"
"\r\n\r\n";

const char *START_MESSG =
"Welcome.  This is your new Mudgik II character!  You can now earn gold,\r\n"
