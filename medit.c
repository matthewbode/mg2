...
/*-------------------------------------------------------------------*/
  case MEDIT_SETTER:
    GET_LEVEL(OLC_MOB(d)) = LIMIT(i, 1, 125);
    GET_AC(OLC_MOB(d)) = 100 - (GET_LEVEL(OLC_MOB(d)) * 3);
    /*
    GET_DAMROLL(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) * 11 / 4;
    GET_HITROLL(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) * 11 / 4;
    */
    GET_DAMROLL(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) / 2.75;
    GET_HITROLL(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) / 2.75;
    GET_NDD(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) / 10 + 1;
    GET_SDD(OLC_MOB(d)) = GET_LEVEL(OLC_MOB(d)) / 4;
    GET_MOVE(OLC_MOB(d)) = ((100 + (GET_LEVEL(OLC_MOB(d)) * 15)) * GET_LEVEL(OLC_MOB(d)) * GET_LEVEL(OLC_MOB(d))) / (GET_LEVEL(OLC_MOB(d)) * 20);
    GET_EXP(OLC_MOB(d)) = GET_MOVE(OLC_MOB(d)) * 80;
    break;
