...
struct board_info_type board_info[NUM_OF_BOARDS] = {
  ...
  {1218, LVL_IMMORT, LVL_IMPL,   LVL_IMPL,  LIB_ETC "board.imm1",    0},
  {1217, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, LIB_ETC "board.nexus",   0},
  {1215, LVL_IMMORT, LVL_IMMORT, LVL_IMPL,  LIB_ETC "board.isocial", 0},
  {1214, LVL_IMMORT, LVL_IMMORT, LVL_IMPL,  LIB_ETC "board.todo",    0},
  {1213, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, LIB_ETC "board.build",   0},
  {1212, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, LIB_ETC "board.code",    0},
  {1211, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, LIB_ETC "board.script",  0},
  {1618, 0,          0,          LVL_IMMORT,LIB_ETC "board.knight",  0},
  {1654, 0,          0,          LVL_IMMORT,LIB_ETC "board.cavalier",0},
};
...
int Board_show_board(int board_type, struct char_data * ch, char *arg, struct obj_data *board)
{
  ...
  strcpy(buf,
         "This is a public notice board ------------------------------->\r\n"
         "Type 'write <title of message>' to post your message.\r\n"
         "Type 'look board'               to read all messages.\r\n"
         ">------------------------------------------------------------<\r\n");
