...
/* There is a problem with it. It crashes the mud (New OLC maybe?)
  ...
  { "flex"     , POS_STANDING, do_report   , 0, SCMD_FLEX },
  { "flip"     , POS_STANDING, do_action   , 0, 0 },
  { "flirt"    , POS_RESTING , do_action   , 0, 0 },
  { "fly"      , POS_STANDING, do_depth    , 1, SCMD_FLY },
  ...
  { "hedit"    , POS_DEAD    , do_oasis	   , LVL_BUILDER, SCMD_OASIS_HEDIT },
...
/* For now, we will disable holler till I can be bothered getting rid of it!
  { "holler"   , POS_RESTING , do_gen_comm , 1, SCMD_HOLLER },
To re-enable it, just delete these lines */
  ...
  { "map"      , POS_RESTING , do_map      , 0, SCMD_MAP },
  ...
  { "poofin"   , POS_DEAD    , do_poofin   , LVL_IMMORT, SCMD_POOFIN },
  { "poofout"  , POS_DEAD    , do_poofout  , LVL_IMMORT, SCMD_POOFOUT },
...
// Private Channel Commands.
  ...
  { "pcheck"   , POS_DEAD    , do_private_channel , LVL_GRGOD, PRIVATE_CHECK },
// Private Channel Commands.
  ...
  { "report"   , POS_RESTING , do_report   , 0, SCMD_REPORT },
  ...
  { "role"     , POS_SLEEPING, do_gen_comm , 0, SCMD_ROLE },
  { "roll"     , POS_RESTING , do_action   , 0, 0 },
  { "roomflags", POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_ROOMFLAGS },
  { "ruffle"   , POS_STANDING, do_action   , 0, 0 },
  { "rclone"   , POS_DEAD    , do_copyto   , LVL_BUILDER, SCMD_RCLONE },
  { "rcopy"    , POS_DEAD    , do_copyto   , LVL_BUILDER, SCMD_RCOPY },

  { "say"      , POS_RESTING , do_say      , 0, 0 },
  { "'"        , POS_RESTING , do_say      , 0, 0 },
  { "save"     , POS_SLEEPING, do_save     , 0, 0 },
  { "saveall"  , POS_DEAD    , do_saveall  , LVL_GRGOD, 0 },
  { "score"    , POS_DEAD    , do_score    , 0, 0 },
  { "scan"     , POS_STANDING, do_scan     , LVL_GOD, 0 },
  ...
  { "swim"     , POS_STANDING, do_depth    , 1, SCMD_SWIM },
 ...
 /* { "who"      , POS_DEAD    , do_who      , 0, 0 }, */
  ...
  { "zdelete"  , POS_DEAD    , do_zdelete  , LVL_BUILDER, 0 },
  ...
  /* External Programs - Testing! */
  { "nexus"    , POS_DEAD    , do_nexus    , LVL_IMPL, 0 },
  { "swho"     , POS_DEAD    , do_swho     , LVL_IMPL, 0 },
  { "grep"     , POS_DEAD    , do_grep     , LVL_IMPL, 0 },
  ...
  { "bolt"     , POS_DEAD    , do_bolt     , LVL_GOD, 0 },
  { "anvil"    , POS_DEAD    , do_anvil    , LVL_GRGOD, 0 },
...
int perform_dupe_check(struct descriptor_data *d)
{
  ...
  int mode = 0;
  int former_state = CON_PLAYING;
  void *former_olc = NULL;
  ...
  */
  ...
  STATE(d) = former_state; /* CON_PLAYING; */
  /* OLC(d) = former_olc; */
...
void nanny(struct descriptor_data *d, char *arg)
{
  ...
  case CON_GET_NAME:		/* wait for input of name */
	...
	if (PLR_FLAGGED(d->character, PLR_DELETED)) {
	  ...
	  SEND_TO_Q("\r\n\r\n\r\n\r\n\r\n\r\n\r\n", d);
	  SEND_TO_Q("##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##~~~~~##\r\n", d);
	  SEND_TO_Q("# If this is your first time, welcome.  You may create a new character #\r\n", d);
	  SEND_TO_Q("| to play by confirming the name below.  The character creation        |\r\n", d);
	  SEND_TO_Q("# will then begin.  Remember to choose a name with a fantasy or        #\r\n", d);
	  SEND_TO_Q("| Medival flavour to it.                                               |\r\n", d);
	  SEND_TO_Q("#                                                                      #\r\n", d);
	  SEND_TO_Q("#  Is the name below correct?        [Y]es    or    [N]o               #\r\n", d);
	  SEND_TO_Q("##_____##_____##_____##_____##_____##_____##_____##_____##_____##_____##\r\n", d);
	  SEND_TO_Q("\r\n\r\n\r\n\r\n", d);
  ...
  case CON_NAME_CNFRM:		/* wait for conf. of new name    */
	...
	return;
      ...
      SEND_TO_Q("[ ] Please choose name again.\r\n[ ] -> ", d);
